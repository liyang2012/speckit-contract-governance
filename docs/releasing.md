...
4. Run Bash syntax checks, Bash smoke tests, Python unit tests, distribution validation,
   and PowerShell smoke tests.
5. Install the local directory into a clean Spec Kit fixture and run one initialization,
   validation, audit, diff preview, and SERVICE-MAP preview.
